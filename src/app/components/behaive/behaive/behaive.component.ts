...
@Component({
  selector: 'app-behaive',
  templateUrl: './behaive.component.html',
  styleUrls: ['./behaive.component.css']
})
export class BehaiveComponent {
...
addDegreeActive :boolean = false;
  ...
  activeButton: number = 1; // Default active button index (for example, the last button)
