...
export class LessonService {
  ...
  private privatAPI = 'https://mousahel2-001-site3.ptempurl.com/api/Lesson/CreateLesson';    // private baseUrl = 'https://localhost:7271/api/Lesson/CreateLesson/d8b6056b-2aeb-481e-8ba8-7ecc0de979bd';
  ...
  getAllLessonsBySubjectId(subjectId :string ,pageNumber: number, pageSize: number): Observable<any> {
  ...
  createLesson(lessonData: any): Observable<any> {
    ...
    return this.http.post<any>(`${this.privatAPI}/b24a12f8-132e-4c80-b5b1-42abf795e944`, lessonData);
  }
  ...
  uploadLesson(lessonName: string, lessonResources: File[]): Observable<any> {
    ...
    const url = `https://mousahel2-001-site3.ptempurl.com/api/Lesson/CreateLesson/${subjectId}`;
